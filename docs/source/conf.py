# -*- coding: utf-8 -*-
#
# Koverse documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.intersphinx', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.ifconfig', 'sphinx.ext.viewcode', 'sphinx.ext.graphviz', 'sphinxcontrib.redoc', 'sphinxcontrib.openapi']
#extensions = ['sphinx.ext.autodoc', 'sphinx.ext.intersphinx', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.ifconfig', 'sphinx.ext.viewcode', 'rst2pdf.pdfbuilder', 'javasphinx', 'sphinxcontrib.openapi']
# PDF support via rst2pdf (http://code.google.com/p/rst2pdf/)

redoc = [
    {
        'name': 'Koverse API',
        'page': 'REST_specification',
        'spec': 'api.yaml',
        'embed': True,
    },
]
...
# pixels large.
html_favicon = '_static/Koverse-logo/favicon.ico'
